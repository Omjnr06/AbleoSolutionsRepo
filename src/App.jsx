  ...
  return (
    <div className="app-container">
      ...
      <section id="pricing" className="services" style={{background: '#F0F7F7'}}>
        <div className="container">
          <div className="pricing-info" style={{maxWidth: '800px', margin: '0 auto', background: 'white', border: '2px solid #B8D4D4', borderRadius: '16px', padding: '48px', textAlign: 'center'}}>
      ...
      <section id="contact" className="cta-section" style={{padding: '100px 0', background: '#1B6B6B', color: 'white', textAlign: 'center'}}>
        <div className="container">
          <h2 style={{fontSize: '48px', marginBottom: '20px'}}>Ready to Get Started?</h2>
          <p style={{margin: '0 0 40px', opacity: 0.9}}>Fill out the form below for your free consultation.</p>
          <div style={{ maxWidth: '600px', margin: '0 auto', background: 'white', padding: '40px', borderRadius: '16px', color: '#0F1419', textAlign: 'left' }}>
            <form onSubmit={handleSubmit}>
              ...
              <button type="submit" className="button-primary" style={{width: '100%', border: 'none', cursor: 'pointer', background: '#1B6B6B', color: 'white', padding: '16px', borderRadius: '8px', fontWeight: 'bold'}}>
                Send Request
              </button>
            </form>
          </div>
      ...
      <footer>
        <div className="container">
          <div className="footer-content" style={{display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr', gap: '48px', padding: '60px 0'}}>
            <div>
